...
dotnet user-secrets set "Application:SenderEmail" "Address used to send messages to other users"
dotnet user-secrets set "Application:SenderName" "Name displayed as sender (e.g., NRZMyk System)"
dotnet user-secrets set "Application:NewUserRegisteredTemplateId" "Brevo template id for new user registration"
dotnet user-secrets set "Application:RemindOrganizationOnDispatchMonthTemplateId" "Brevo template id for organization reminder"
